...
base_public_data_filepath <- "C:/Users/ccross/Documents/Projects/COVID-19-Weekly-Report/"
```
...
### <em>COVID-19 Case Trends</em> {.unlisted .unnumbered}
...
Cases are attributed to symptom onset date, if recorded. Otherwise, cases are attributed to specimen collection date, report date or hospitalization date, whichever comes first.</p> <br>
...
### <em>COVID-19 and Hospital Capacity</em> {.unlisted .unnumbered}
...
<p style="font-family: Open Sans; font-size: 15px; color: #000000; text-align: left; line-height: 1.4em;">
For clarity of display, the number of hospital beds occupied is shown for each Saturday. For more data on hospital capacity please visit the Hospital Dashboard or the Hospital Data Tables. All data are preliminary and subject to change first.</p><br>
...
### <em>COVID-19 and Vaccination</em> {.unlisted .unnumbered}
...
### <em>Visits with COVID-like or Influenza-like Illness</em> {.unlisted .unnumbered}
...
## New Updates
### <em>Updates to protect yourself and your family</em> {.unlisted .unnumbered}
