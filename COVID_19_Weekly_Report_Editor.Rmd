...
#Create URL for Public Access
emergency_department_url <- paste0("https://data.dhss.alaska.gov/data/covid/covid_19_flu_weekly_report/public_data/emergency_department_visists/emergency_department_visits_", newFileDate, ".csv")
```
...
<p style="font-family: Open Sans; font-size: 21px; color: #000000; text-align: left; line-height: 1.4em;"><b>
