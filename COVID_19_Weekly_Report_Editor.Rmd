...
<!-- SET HTML WEBPAGE DISPLAY SETTINGS -->
...
base_github_public_data_filepath <- "C:/Users/ccross/Documents/Projects/COVID-19-Weekly-Report/Public_Data/"

base_dhss_public_data_filepath <- "//Hssjnupubweb2/DATADHSSALASKAGOV/data/COVID/COVID_19_Flu_Weekly_Report/Public_Data/"
```
...
#Save CSV to GitHub Public Data Folder
write.csv(cases_csv_dataframe,
          paste0(base_github_public_data_filepath, 
...
#Save CSV to DHSS Public Data Folder
write.csv(cases_csv_dataframe,
          paste0(base_dhss_public_data_filepath, 
                 "Cases_by_Onset_Date/cases_by_onset_date_",
                 newFileDate,
                 ".csv"),
          row.names = FALSE)
...
cases_onset_url <- paste0("https://data.dhss.alaska.gov/data/covid/covid_19_flu_weekly_report/public_data/cases_by_onset_date/cases_by_onset_date_", newFileDate, ".csv")
```
...
write.csv(case_rate_remove_unk,
          paste0(base_github_public_data_filepath,
...
cases_rates_url <- paste0("https://data.dhss.alaska.gov/data/covid/covid_19_flu_weekly_report/public_data/case_rates_by_bca/case_rates_by_bca_", newFileDate, ".csv")
```
...
#Set URL Access Web Address
hosp_beds_url <- paste0("https://data.dhss.alaska.gov/data/covid/covid_19_flu_weekly_report/public_data/hospital_beds_occupied/hospital_beds_occupied_", newFileDate, ".csv")
```
...
#Set URL Access Web Address
vac_unvac_hosp_url <- paste0("https://data.dhss.alaska.gov/data/covid/covid_19_flu_weekly_report/public_data/hospital_rates_by_vaccination_status/hospital_rates_by_vaccination_status_", newFileDate, ".csv")
```
...
#Set URL Access Web Address
vac_unvac_case_url <- paste0("https://data.dhss.alaska.gov/data/covid/covid_19_flu_weekly_report/public_data/case_rates_by_vaccination_status/case_rates_by_vaccination_status_", newFileDate, ".csv")
```
...
flu_season_url <- paste0("https://data.dhss.alaska.gov/data/covid/covid_19_flu_weekly_report/public_data/influenza_by_season/influenza_by_season_", newFileDate, ".csv")
```
...
write.csv(emergency_department_cases,
          paste0(base_github_public_data_filepath,
                 "Emergency_Department_Visits/emergency_department_visits_",
                 newFileDate,
                 ".csv"),
          row.names = FALSE)
...
#Create URL for Public Access
emergency_department_url <- paste0("https://data.dhss.alaska.gov/data/covid/covid_19_flu_weekly_report/public_data/emergency_department_visits/emergency_department_visits_", newFileDate, ".csv")
```
...
<p style="font-family: Arial; font-size: 20px; color: #000000; text-align: left; line-height: 1.4em;"><b>
...
<p style="font-family: Open Sans; font-size: 18px; color: #000000; text-align: left; line-height: 1.4em;">
...
<p style="font-family: Open Sans; font-size: 20px; color: #000000; text-align: left; line-height: 1.4em;"><b>
Subscribe to Updates from Alaska DHSS</b><br></p>

<input type="submit" value="Subscribe" class = "submit" formaction="https://public.govdelivery.com/accounts/AKDHSS/subscriber/qualify" formtarget="_blank" formmethod="get" onClick ="parent.location='https://public.govdelivery.com/accounts/AKDHSS/subscriber/qualify'">

<p>&nbsp;</p>

<p style="font-family: Open Sans; font-size: 20px; color: #000000; text-align: left; line-height: 1.4em;"><b>
Share Bulletin</b><br></p>

<div class="share-link-container"><a class="social-sharing-link" href="https://www.facebook.com/sharer.php?u=https://content.govdelivery.com/accounts/AKDHSS/bulletins/315b292?reqfrom=share" target="_blank" rel="noopener noreferrer"><img alt="share this bulletin on Facebook" src="https://content.govdelivery.com/assets/art/share_facebook-91b530a60fb05e3af56bdf009be581bf4a12c2c76869d0977348c57b79e2b5a8.png"></a><a class="social-sharing-link" href="https://twitter.com/intent/tweet?url=https://content.govdelivery.com/accounts/AKDHSS/bulletins/315b292?reqfrom=share%2F&amp;text=Alaska COVID-19 and Influenza Weekly Case Update: April 17 – April 23, 2022" target="_blank" rel="noopener noreferrer"><img alt="share this bulletin on Twitter" src="https://content.govdelivery.com/assets/art/share_twitter-ce26b5cc22b7873dabd0194c50be633379881724561f6d5c5622215fe4e28a1b.png"></a><a class="social-sharing-link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https://content.govdelivery.com/accounts/AKDHSS/bulletins/315b292?reqfrom=share%2F&amp;source=govDelivery" target="_blank" rel="noopener noreferrer"><img alt="share this bulletin on LinkedIn" src="https://content.govdelivery.com/assets/art/share_linkedin-7e860813f5305f5c33e2548305528824a4846e7a8eac4a658d2a003995cdb7a5.png"></a><a class="social-sharing-link" href="mailto:?subject=Alaska COVID-19 and Influenza Weekly Case Update: April 17 – April 23, 2022&amp;body=https://content.govdelivery.com/accounts/AKDHSS/bulletins/315b292?reqfrom=share" target="_blank" rel="noopener noreferrer"><img alt="share this bulletin via email" src="https://content.govdelivery.com/assets/art/share_email-ecb03e091ef7d077856720b5cded62d7a6f89f923e53b9c86f6d4d6f81442b8f.png"></a></div>
...
h4.author { /* Header 4 - USE THIS TO EDIT TITLE OF DOC  */
  font-size: 30px;
  font-family: "Arial";
  font-weight: 700;
  color: Black;
